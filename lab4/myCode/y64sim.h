...
typedef enum { 
  REG_ERR=-1, 	REG_RAX, REG_RCX, REG_RDX, REG_RBX,
    		REG_RSP, REG_RBP, REG_RSI, REG_RDI, 
   		REG_R8 , REG_R9 , REG_R10, REG_R11,
    		REG_R12, REG_R13, REG_R14, REG_NONE } regid_t;
...
/* Y64 Instruction
 In this place, the TA miss the instruction cmoveXX(conditional move). But what the fucking thing is the I_DIRECTIVE ????
 */
...
/* Condition code 
	C_YES is the condition that just move
*/
...
/* Pack itype and func/alu/cond/dtv into single byte 
 In this place, TA is really thoughtful
